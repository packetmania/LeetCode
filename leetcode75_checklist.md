...
| 4 | [605](https://leetcode.com/problems/can-place-flowers/) | Can Place Flowers | Array/String | Array, Greedy | Check adjacent positions before placing | Easy | ☐ |
| 5 | [345](https://leetcode.com/problems/reverse-vowels-of-a-string/) | Reverse Vowels of a String | Array/String | Two Pointers, String | Use two pointers from start and end | Easy | ☐ |
| 6 | [151](https://leetcode.com/problems/reverse-words-in-a-string/) | Reverse Words in a String | Array/String | Two Pointers, String | Split by spaces and reverse order | Medium | ☐ |
| 7 | [238](https://leetcode.com/problems/product-of-array-except-self/) | Product of Array Except Self | Array/String | Array, Prefix Sum | Use left and right product arrays | Medium | ☐ |
| 8 | [334](https://leetcode.com/problems/increasing-triplet-subsequence/) | Increasing Triplet Subsequence | Array/String | Array, Greedy | Track smallest and second smallest values | Medium | ☐ |
| 9 | [443](https://leetcode.com/problems/string-compression/) | String Compression | Array/String | Two Pointers, String | Count consecutive characters | Medium | ☐ |
| 10 | [283](https://leetcode.com/problems/move-zeroes/) | Move Zeroes | Two Pointers | Array, Two Pointers | Use write pointer to place non-zero elements | Easy | ☐ |
| 11 | [392](https://leetcode.com/problems/is-subsequence/) | Is Subsequence | Two Pointers | Two Pointers, String, DP | Use two pointers to match characters | Easy | ☐ |
| 12 | [11](https://leetcode.com/problems/container-with-most-water/) | Container With Most Water | Two Pointers | Array, Two Pointers, Greedy | Start from both ends, move shorter line | Medium | ☐ |
| 13 | [1679](https://leetcode.com/problems/max-number-of-k-sum-pairs/) | Max Number of K-Sum Pairs | Two Pointers | Array, Hash Table, Two Pointers | Sort array or use hash map | Medium | ☐ |
| 14 | [643](https://leetcode.com/problems/maximum-average-subarray-i/) | Maximum Average Subarray I | Sliding Window | Array, Sliding Window | Use sliding window of size k | Easy | ☐ |
| 15 | [1456](https://leetcode.com/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) | Maximum Number of Vowels in a Substring of Given Length | Sliding Window | String, Sliding Window | Slide window and count vowels | Medium | ☐ |
| 16 | [1004](https://leetcode.com/problems/max-consecutive-ones-iii/) | Max Consecutive Ones III | Sliding Window | Array, Binary Search, Sliding Window, Prefix Sum | Use sliding window with at most k zeros | Medium | ☐ |
| 17 | [1493](https://leetcode.com/problems/longest-subarray-of-1s-after-deleting-one-element/) | Longest Subarray of 1's After Deleting One Element | Sliding Window | Array, Binary Search, Sliding Window | Allow at most one zero in window | Medium | ☐ |
| 18 | [1732](https://leetcode.com/problems/find-the-highest-altitude/) | Find the Highest Altitude | Prefix Sum | Array, Prefix Sum | Keep running sum of gains | Easy | ☐ |
| 19 | [724](https://leetcode.com/problems/find-pivot-index/) | Find Pivot Index | Prefix Sum | Array, Prefix Sum | Check if left sum equals right sum | Easy | ☐ |
| 20 | [2215](https://leetcode.com/problems/find-the-difference-of-two-arrays/) | Find the Difference of Two Arrays | Hash Map/Set | Array, Hash Table | Use sets to find unique elements | Easy | ☐ |
| 21 | [1207](https://leetcode.com/problems/unique-number-of-occurrences/) | Unique Number of Occurrences | Hash Map/Set | Array, Hash Table | Count frequencies, check uniqueness | Easy | ☐ |
| 22 | [1657](https://leetcode.com/problems/determine-if-two-strings-are-close/) | Determine if Two Strings Are Close | Hash Map/Set | Hash Table, String, Sorting | Check character sets and frequency patterns | Medium | ☐ |
| 23 | [2352](https://leetcode.com/problems/equal-row-and-column-pairs/) | Equal Row and Column Pairs | Hash Map/Set | Array, Hash Table, Matrix, Simulation | Convert rows/columns to comparable format | Medium | ☐ |
| 24 | [2390](https://leetcode.com/problems/removing-stars-from-a-string/) | Removing Stars From a String | Stack | String, Stack, Simulation | Use stack to handle star removals | Medium | ☐ |
| 25 | [735](https://leetcode.com/problems/asteroid-collision/) | Asteroid Collision | Stack | Array, Stack, Simulation | Simulate collisions with stack | Medium | ☐ |
| 26 | [394](https://leetcode.com/problems/decode-string/) | Decode String | Stack | String, Stack, Recursion | Use stack to handle nested brackets | Medium | ☐ |
| 27 | [933](https://leetcode.com/problems/number-of-recent-calls/) | Number of Recent Calls | Queue | Design, Queue, Data Stream | Use queue to maintain time window | Easy | ☐ |
| 28 | [649](https://leetcode.com/problems/dota2-senate/) | Dota2 Senate | Queue | String, Greedy, Queue | Use two queues for each party | Medium | ☐ |
| 29 | [2095](https://leetcode.com/problems/delete-the-middle-node-of-a-linked-list/) | Delete the Middle Node of a Linked List | Linked List | Linked List, Two Pointers | Use slow/fast pointers to find middle | Medium | ☐ |
| 30 | [328](https://leetcode.com/problems/odd-even-linked-list/) | Odd Even Linked List | Linked List | Linked List | Separate odd/even positioned nodes | Medium | ☐ |
| 31 | [206](https://leetcode.com/problems/reverse-linked-list/) | Reverse Linked List | Linked List | Linked List, Recursion | Use iterative or recursive approach | Easy | ☐ |
...
| 60 | [746](https://leetcode.com/problems/min-cost-climbing-stairs/) | Min Cost Climbing Stairs | DP - 1D | Array, DP | Choose minimum cost path | Easy | ☐ |
