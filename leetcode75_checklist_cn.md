...
| 4 | [605](https://leetcode.cn/problems/can-place-flowers/) | 种花问题 | 数组/字符串 | 数组, 贪心 | 放花前检查相邻位置 | 简单 | ☐ |
| 5 | [345](https://leetcode.cn/problems/reverse-vowels-of-a-string/) | 反转字符串中的元音字母 | 数组/字符串 | 双指针, 字符串 | 使用双指针从两端遍历 | 简单 | ☐ |
| 6 | [151](https://leetcode.cn/problems/reverse-words-in-a-string/) | 翻转字符串里的单词 | 数组/字符串 | 双指针, 字符串 | 按空格分割并反转顺序 | 中等 | ☐ |
| 7 | [238](https://leetcode.cn/problems/product-of-array-except-self/) | 除自身以外数组的乘积 | 数组/字符串 | 数组, 前缀和 | 使用左右乘积数组 | 中等 | ☐ |
| 8 | [334](https://leetcode.cn/problems/increasing-triplet-subsequence/) | 递增的三元子序列 | 数组/字符串 | 数组, 贪心 | 记录最小和次小值 | 中等 | ☐ |
| 9 | [443](https://leetcode.cn/problems/string-compression/) | 压缩字符串 | 数组/字符串 | 双指针, 字符串 | 统计连续字符 | 中等 | ☐ |
| 10 | [283](https://leetcode.cn/problems/move-zeroes/) | 移动零 | 双指针 | 数组, 双指针 | 用写指针放非零元素 | 简单 | ☐ |
| 11 | [392](https://leetcode.cn/problems/is-subsequence/) | 判断子序列 | 双指针 | 双指针, 字符串, 动态规划 | 用双指针匹配字符 | 简单 | ☐ |
| 12 | [11](https://leetcode.cn/problems/container-with-most-water/) | 盛最多水的容器 | 双指针 | 数组, 双指针, 贪心 | 从两端开始，移动较短的线 | 中等 | ☐ |
| 13 | [1679](https://leetcode.cn/problems/max-number-of-k-sum-pairs/) | 和为 K 的数对最大数目 | 双指针 | 数组, 哈希表, 双指针 | 排序或用哈希表 | 中等 | ☐ |
| 14 | [643](https://leetcode.cn/problems/maximum-average-subarray-i/) | 子数组最大平均数 I | 滑动窗口 | 数组, 滑动窗口 | 使用大小为 k 的滑动窗口 | 简单 | ☐ |
| 15 | [1456](https://leetcode.cn/problems/maximum-number-of-vowels-in-a-substring-of-given-length/) | 定长子串中元音的最大数目 | 滑动窗口 | 字符串, 滑动窗口 | 滑动窗口统计元音数 | 中等 | ☐ |
| 16 | [1004](https://leetcode.cn/problems/max-consecutive-ones-iii/) | 最大连续 1 的个数 III | 滑动窗口 | 数组, 二分, 滑动窗口, 前缀和 | 滑动窗口最多包含 k 个零 | 中等 | ☐ |
| 17 | [1493](https://leetcode.cn/problems/longest-subarray-of-1s-after-deleting-one-element/) | 删掉一个元素以后全为 1 的最长子数组 | 滑动窗口 | 数组, 二分, 滑动窗口 | 窗口最多允许一个零 | 中等 | ☐ |
| 18 | [1732](https://leetcode.cn/problems/find-the-highest-altitude/) | 找到最高海拔 | 前缀和 | 数组, 前缀和 | 记录累计海拔 | 简单 | ☐ |
| 19 | [724](https://leetcode.cn/problems/find-pivot-index/) | 寻找数组的中心下标 | 前缀和 | 数组, 前缀和 | 判断左右和是否相等 | 简单 | ☐ |
| 20 | [2215](https://leetcode.cn/problems/find-the-difference-of-two-arrays/) | 找出两数组的不同 | 哈希表/集合 | 数组, 哈希表 | 用集合找唯一元素 | 简单 | ☐ |
| 21 | [1207](https://leetcode.cn/problems/unique-number-of-occurrences/) | 独一无二的出现次数 | 哈希表/集合 | 数组, 哈希表 | 统计频率并判断唯一性 | 简单 | ☐ |
| 22 | [1657](https://leetcode.cn/problems/determine-if-two-strings-are-close/) | 判断两个字符串是否接近 | 哈希表/集合 | 哈希表, 字符串, 排序 | 判断字符集和频率模式 | 中等 | ☐ |
| 23 | [2352](https://leetcode.cn/problems/equal-row-and-column-pairs/) | 相等行列对 | 哈希表/集合 | 数组, 哈希表, 矩阵, 模拟 | 行列转为可比较格式 | 中等 | ☐ |
| 24 | [2390](https://leetcode.cn/problems/removing-stars-from-a-string/) | 从字符串中移除星号 | 栈 | 字符串, 栈, 模拟 | 用栈处理星号移除 | 中等 | ☐ |
| 25 | [735](https://leetcode.cn/problems/asteroid-collision/) | 行星碰撞 | 栈 | 数组, 栈, 模拟 | 用栈模拟碰撞 | 中等 | ☐ |
| 26 | [394](https://leetcode.cn/problems/decode-string/) | 字符串解码 | 栈 | 字符串, 栈, 递归 | 用栈处理嵌套括号 | 中等 | ☐ |
| 27 | [933](https://leetcode.cn/problems/number-of-recent-calls/) | 最近的请求次数 | 队列 | 设计, 队列, 数据流 | 用队列维护时间窗口 | 简单 | ☐ |
| 28 | [649](https://leetcode.cn/problems/dota2-senate/) | Dota2 参议院 | 队列 | 字符串, 贪心, 队列 | 用两个队列分别存储两党 | 中等 | ☐ |
| 29 | [2095](https://leetcode.cn/problems/delete-the-middle-node-of-a-linked-list/) | 删除链表的中间节点 | 链表 | 链表, 双指针 | 快慢指针找中间节点 | 中等 | ☐ |
| 30 | [328](https://leetcode.cn/problems/odd-even-linked-list/) | 奇偶链表 | 链表 | 链表 | 分离奇偶位置节点 | 中等 | ☐ |
| 31 | [206](https://leetcode.cn/problems/reverse-linked-list/) | 反转链表 | 链表 | 链表, 递归 | 迭代或递归反转 | 简单 | ☐ |
| 32 | [2130](https://leetcode.cn/problems/maximum-twin-sum-of-a-linked-list/) | 链表最大孪生和 | 链表 | 链表, 双指针, 栈 | 找中点，反转后半部分 | 中等 | ☐ |
| 33 | [104](https://leetcode.cn/problems/maximum-depth-of-binary-tree/) | 二叉树的最大深度 | 二叉树-DFS | 树, DFS, BFS, 二叉树 | 递归或层序遍历 | 简单 | ☐ |
| 34 | [872](https://leetcode.cn/problems/leaf-similar-trees/) | 叶子相似的树 | 二叉树-DFS | 树, DFS, 二叉树 | 比较叶子序列 | 简单 | ☐ |
| 35 | [1448](https://leetcode.cn/problems/count-good-nodes-in-binary-tree/) | 统计二叉树中好节点的数目 | 二叉树-DFS | 树, DFS, 二叉树 | 路径中记录最大值 | 中等 | ☐ |
...
| 72 | [435](https://leetcode.cn/problems/non-overlapping-intervals/) | 无重叠区间 | 区间 | 数组, 动态规划, 贪心, 排序 | 按结束时间排序，贪心选择 | 中等 | ☐ |
